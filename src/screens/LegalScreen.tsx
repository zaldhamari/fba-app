...
const s = StyleSheet.create({
  ...
  eyebrow: {
    fontSize: 10, fontWeight: '800', color: colors.cyan,
  ...
  emailChipLabel: {
    fontSize: 9, fontWeight: '800', color: colors.cyan, letterSpacing: 2,
  },
  emailChipValue: {
    flex: 1, fontSize: 14, fontWeight: '600', color: colors.textPrimary,
  },
  emailChipArrow: { fontSize: 16, color: colors.cyan, fontWeight: '700' },
  ...
  actionIcon: { fontSize: 16, color: colors.cyan },
